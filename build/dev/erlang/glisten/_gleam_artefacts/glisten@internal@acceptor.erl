...
-type pool(HQP, HQQ) :: {pool,
        glisten@socket:listen_socket(),
        fun((glisten@internal@handler:loop_message(HQP), HQQ, glisten@internal@handler:connection(HQP)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(HQP), HQQ)),
        integer(),
        fun((glisten@internal@handler:connection(HQP)) -> {HQQ,
            gleam@option:option(gleam@erlang@process:selector(HQP))}),
        gleam@option:option(fun((HQQ) -> nil)),
        glisten@transport:transport()}.
